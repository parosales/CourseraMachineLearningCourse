...
## Understanding the Data:  Exploring and Profiling
...
Two plots of predictors will be used to visualize some aspects of the model; the first is the importance 
of predictors:

```{r echo = FALSE}
#plot(varImp(rf_fit_1), main = "Figure 1.  Importance vs Predictors")
```

And the second plot corresponds to the predictors that are 3rd and 4th in importance to predict the classe.

```{r echo = FALSE}
#qplot(roll_belt, pitch_forearm,  data = final_testing_set, color = classe, main = "roll_belt and pitch_forearem as Predictors of Classe")
```
